<%@ Page Title="" Language="C#" MasterPageFile="~/Öğretmen.master" AutoEventWireup="true" CodeFile="OgrenciEkle.aspx.cs" Inherits="OgrenciEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
	<form id="form1" runat="server">
		...
		<asp:Button ID="Button1" runat="server" Text="Kaydet" CssClass="btn-info" OnClick="Button1_Click" />
