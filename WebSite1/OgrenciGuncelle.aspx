<%@ Page Title="" Language="C#" MasterPageFile="~/Öğretmen.master" AutoEventWireup="true" CodeFile="OgrenciGuncelle.aspx.cs" Inherits="OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
	...
	<form id="form1" runat="server">
		...
		<div class="form-group">
			...
			<div>
			<asp:Label for="txtOgrTel" runat="server">Öğrenci Tel No:</asp:Label>
		...
		<asp:Button ID="Button1" runat="server" Text="Güncelle" CssClass="btn btn-toolbar" OnClick="Button1_Click1" />
